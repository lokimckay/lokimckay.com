...
<Image src="space-dungeon-splash.png" />

## Team

<Image src="space-dungeon-team.png" />

_left to right_

| Name                                                                     | Responsibilities                              |
| ------------------------------------------------------------------------ | --------------------------------------------- |
| [Lachlan McKay](https://github.com/lokimckay)                            | VR Programming & Assistant Project Management |
...
- Source code in the [Github repository](https://github.com/lokimckay/spacedungeon-ggj2018)
